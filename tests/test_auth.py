...
from auth.security import verify_password, create_access_token, get_user, get_password_hash, SECRET_KEY, ALGORITHM
...
class TestSecurityUtilities:
    ...
    def test_get_current_user_via_discovery_valid_token(self):
        """Test get_current_user melalui discovery endpoint dengan token valid"""
        # Get valid token
    ...
    def test_get_current_user_via_discovery_invalid_token(self):
        """Test get_current_user melalui discovery endpoint dengan token invalid"""
        response = client.post(
            "/discovery/",
            json={"category": "Tutorial"},
